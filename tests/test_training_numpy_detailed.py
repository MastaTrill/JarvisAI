...
class TestNumpyTraining:
    ...
    def test_trainer_initialization(self):
        ...
        trainer = NumpyTrainer(model=model, learning_rate=0.01, batch_size=32)
    ...
    def test_full_training(self):
        ...
        history = trainer.train(
            X_train=X_train, y_train=y_train, X_val=X_val, y_val=y_val, epochs=5
        )
    ...
    def test_training_with_validation(self):
        ...
        history = trainer.train(
            X_train=X_train, y_train=y_train, X_val=X_val, y_val=y_val, epochs=3
        )
