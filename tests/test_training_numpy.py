...
class TestSimpleNeuralNetwork:
    ...
    def test_forward_pass(self):
        """Test forward pass"""
        model = SimpleNeuralNetwork(input_size=5, hidden_sizes=[10], output_size=1)
        x = np.random.randn(3, 5)
        activations, _ = model.forward_pass(x)
    ...
    def test_model_save_load(self):
        ...
        model = SimpleNeuralNetwork(input_size=3, hidden_sizes=[5], output_size=1)
...
class TestNumpyTrainer:
    ...
    def setup_method(self):
        ...
        self.model = SimpleNeuralNetwork(input_size=5, hidden_sizes=[10], output_size=1)
            ...
            try:
                ...
                new_trainer = NumpyTrainer(
                    model=SimpleNeuralNetwork(
                        input_size=5, hidden_sizes=[10], output_size=1
                    )
                )
